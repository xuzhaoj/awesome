...
func (m *MockArticleAuthorRepository) UpdateById(ctx context.Context, art domain.Article) error {
	m.ctrl.T.Helper()
...
func (mr *MockArticleAuthorRepositoryMockRecorder) UpdateById(ctx, art any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateById", reflect.TypeOf((*MockArticleAuthorRepository)(nil).UpdateById), ctx, art)
}
